...
from pretrain.lxmert_data import InputExample, LXMERTDataset, LXMERTTorchDataset, LXMERTEvaluator, TINY_IMG_NUM, FAST_IMG_NUM
...
#elif args.fast:
#    topk=FAST_IMG_NUM
#valid_tuple = get_tuple(args.valid, valid_batch_size, shuffle=False, drop_last=False, topk=topk)
